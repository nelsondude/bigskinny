  ...
  return (
    <div style={{color: 'white'}}>
      ...
      <p>
        ...
        <br/>
        <br/>
        Sed sodales tristique imperdiet. Integer nec facilisis sem. Duis ut lobortis nulla. Etiam tincidunt facilisis pretium. Sed auctor magna vitae lacus congue, ut rutrum est pretium. Duis dignissim tincidunt massa, ut commodo elit dignissim dapibus. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Morbi tortor massa, pulvinar a libero vel, vehicula suscipit orci. Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.
      </p>
    </div>
  )
}